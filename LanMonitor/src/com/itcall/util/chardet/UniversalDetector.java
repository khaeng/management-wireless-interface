...
import com.itcall.util.chardet.prober.CharsetProber;
import com.itcall.util.chardet.prober.MBCSGroupProber;
import com.itcall.util.chardet.prober.SBCSGroupProber;
import com.itcall.util.chardet.prober.EscCharsetProber;
import com.itcall.util.chardet.prober.Latin1Prober;
import com.itcall.util.chardet.Constants;

/**
 * <PRE>
 * <b>UniversalDetector</b>
 * <b>파일의 문자셋 찾아주기</b>
 * 
 * 지정된 파일의 문자셋을 자동으로 찾아서 반환한다.
 * https://code.google.com/p/juniversalchardet/source/checkout <br>
 * http://juniversalchardet.googlecode.com/svn/trunk/ <br>
 * 
